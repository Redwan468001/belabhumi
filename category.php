						...
						<div class="col-lg-12 col-md-12 col-xs-12" style="padding:0"> 
							<div id="section_4_right" style="margin:0">
								...
								<div class="section_4_art_top"> 
                					...
                					?>
									<div class="col-lg-6 col-md-6 col-xs-12 sng_page"><a href="<?php the_permalink(); ?>">
										<div id="sng_sct4_art_img" class="sng_page_img"> 
											<?php the_post_thumbnail(); ?>
										</div>
										<div id="sng_sct4_art_cnt" class="sng_page_cnt">
											<h2><?php the_title(); ?></h2> 
											<div id="post_meta">
