<?php get_header(); ?>
	...
	<div class="container_full page_bg"> 
				...
				<div class="col-lg-8 col-md-8 col-xs-12" style="padding-right:0px;box-shadow: 6px 0px 3px -2px #ddd;"> 
					<div class="section_left">
						...
						<div class="col-lg-12 col-md-12 col-xs-12" style="padding:0"> 
							<div id="section_4_right" style="margin:0">
							
            				    <h2>Search Results For: " <span style="color:green;font-weight:bold"><?php the_search_query(); ?> </span>"</h2>
            					<p style="color:red;"><?php $allsearch = new WP_Query("s=$s&showposts=0"); echo 'Found ' . $allsearch ->found_posts.' results .';?></p>
								...
								<div class="section_4_art_top"> 
                					...
                					?>
									<div class="col-lg-12 col-md-12 col-xs-12"><a href="<?php the_permalink(); ?>">
